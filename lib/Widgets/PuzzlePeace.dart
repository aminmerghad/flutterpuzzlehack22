...
class RenderCustomBox extends RenderShiftedBox
  ...
  set randIndex(int rI) {
    if (_randIndex == rI) return;
    _randIndex = rI;
  }
  ...
  set initialAnimationValue(double v) {
    ...
    if (v == 1) {
      solution2 = solution.map((e) {
        Offset ld = e * rap;
        return Offset(ld.dx.round().toDouble(), ld.dy.round().toDouble());
      }).toList();
      missedPeace =
  ...
  void onTap() {
    ...
    if (isReady == true && initialAnimationValue == 1 && tile > 0) {
      ...
      if (solution2.contains(
          Offset(ofq.dx.round().toDouble(), ofq.dy.round().toDouble()))) {
...
// assert(debugHandleEvent(event, entry));
    ...
    //   return;
    // }
  // PointerHoverEventListener? onHover(PointerHoverEvent l) {}
// void paintPyramide(double offsx, double height, double width, Canvas canvas) {
//     Path path2 = Path()
//       ..moveTo(offsx, height - 15)
//       ..lineTo(offsx + (width - offsx) / 2, height - 60)
//       ..lineTo(width, height - 15)
//       ..lineTo(width, height)
//       ..lineTo(offsx, height)
//       ..lineTo(offsx, height - 15);
//     canvas.drawPath(path2, Paint()..color = color);
//     Path path3 = Path()
//       ..moveTo(width, height - 22)
//       ..lineTo(offsx + (width - offsx) / 2, height - 60)
//       ..lineTo(width, height - 15)
//       ..lineTo(width, height - 22);
//     canvas.drawPath(path3, Paint()..color = Colors.tealAccent[700] as Color
//         // Colors.tealAccent
//         //     ? Colors.tealAccent[400] as Color
//         //     : Colors.tealAccent[700] as Color
//         );
//     Path path4 = Path()
//       ..moveTo(offsx, height - 22)
//       ..lineTo(offsx + (width - offsx) / 2, height - 60)
//       ..lineTo(offsx, height - 15)
//       ..lineTo(offsx, height - 22);
//     canvas.drawPath(path4, Paint()..color = Colors.tealAccent[700] as Color
